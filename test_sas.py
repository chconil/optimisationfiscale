...
print()
print(f"Résultat après salaire: {scenario['resultat_apres_salaire']:,.0f}€")
...
print(f"Résultat après salaire dans scenario: {scenario['resultat_apres_salaire']:,.0f}€")
print(f"Cohérent: {resultat_apres == scenario['resultat_apres_salaire']}")
